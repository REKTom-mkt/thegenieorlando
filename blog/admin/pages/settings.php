        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $bloginfo->site_url; ?>" name="site_url" />
                </div>

                <div class="form-group">
                    <label>Blog URL </label>
                    <input type="text" class="form-control" value="<?php echo $bloginfo->blog_url; ?>" name="blog_url" />
                </div>
                ...
                <div class="form-group">
                    <label>Listing Page Short Description (Max - Chars per post)</label>
                    <input type="number" class="form-control" value="<?php echo $bloginfo->listing_description_count; ?>" name="listing_description_count" />
                </div>
                <div class="form-group">
            ...
            <div class="col-12 col-md-6 social_media_settings">
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" <?= checked($bloginfo->allow_sharing, '1'); ?> value="1" name="allow_sharing" id="social-share-option">
                        <label class="custom-control-label" for="social-share-option">Enable Social Media Share Buttons</label>
                    </div>
                </div>
            </div>
            <!--Col 2 End-->
