            ...
            <div class="col-12">
                <form action="" class="full-width-form" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="password" maxlength="50" class="form-control" value="" name="user_new_password" required="required" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="password" maxlength="50" class="form-control" value="" name="user_cnew_password" required="required" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
