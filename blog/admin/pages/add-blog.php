        ...
        <form action="" class="add_blog_design" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group blog_custom_url">
                ...
                <div class="form-row">
                    <div class="col-1 text-left">
                        <label class="switch">
                            <input type="checkbox" name="custom_url_switch" value="1" checked>
            ...
            <div class="form-row">
                <div class="col-12">
                    ...
                    <div class="custom-control custom-checkbox py-2" id="hide_banner">
                        <input type="checkbox" class="custom-control-input" id="hide_banner_input" name="hide_banner" value="1">
