                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if (isset($_POST['register_submit'])) {
                            ...
                            $loginstatus = $user->first_admin_signup();

                            if ($loginstatus > 0) {

                                $pageurl = admin_url();
                                echo "<div class='alert alert-success text-center'>Super admin account has been created. <a href='" . $pageurl . "'>Login here</a></div>";
                        ...
                        <form action="" class="form-signin form-design" method="post" autocomplete="off">
                            ...
                            <p class="position-relative">
                                ...
                                <input type="password" maxlength="50" id="user_password" class="form-control" name="user_password" placeholder="Enter your password." required="required" />
                            </p>
