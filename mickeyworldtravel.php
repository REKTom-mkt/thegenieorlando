<?php
    ...
    $redirect_after_login = 'mickeyworldtravel.php';
...
<head>
    ...
    <title>Mickey World Travel</title>
    ...
    <section class="py-4 py-sm-5 py-md-6">
        <div class="container-xxl">
            ...
            <div class="text-center">
                <script src='https://thegenietrans.mylimobiz.com/leads/new/forms/resize/expander.php' config='10'></script>
