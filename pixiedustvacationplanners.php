<?php
    ...
    $redirect_after_login = 'pixiedustvacationplanners.php';
...
<head>
    ...
    <title>Pixie Dust Vacation Planners</title>
...
<body id="top">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="disney-stroller-rental.html.html" title="Orlando Stroller Rentals">Orlando Stroller Rentals</a></li>
                                </ul>
                            </li>
    ...
    <section class="banner banner--page">
        ...
        <div class="banner-caption" data-aos="fade-left" data-aos-delay="400">
            <h1>Pixie Dust Vacation Planners</h1>
        </div>
    </section>
    ...
    <section class="py-4 py-sm-5 py-md-6">
        <div class="container-xxl">
            ...
            <div class="text-center">
                <script src='https://thegenietrans.mylimobiz.com/leads/new/forms/resize/expander.php' config='11'></script>
