<?php
    ...
    $redirect_after_login = 'ifyoucandreamittravel.php';
...
<head>
    ...
    <title>If You Can Dream It Travel</title>
...
<body id="top">
    ...
    <section class="banner banner--page">
        ...
        <div class="banner-caption" data-aos="fade-left" data-aos-delay="400">
            <h1>If You Can Dream It Travel</h1>
        </div>
    </section>
    ...
    <section class="py-4 py-sm-5 py-md-6">
        <div class="container-xxl">
            ...
            <div class="text-center">
                <script src='https://thegenietrans.mylimobiz.com/leads/new/forms/resize/expander.php' config='6'></script>
