<?php
    ...
    $redirect_after_login = 'mickeytravels.php';
    ...
    <section class="py-4 py-sm-5 py-md-6">
        <div class="container-xxl">
            ...
            <div class="text-center">
                <script src='https://thegenietrans.mylimobiz.com/leads/new/forms/resize/expander.php' config='9'></script>
